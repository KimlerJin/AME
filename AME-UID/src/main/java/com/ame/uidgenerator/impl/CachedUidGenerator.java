 ...
 */
package com.ame.uidgenerator.impl;


import com.ame.uidgenerator.exception.UidGenerateException;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.beans.factory.DisposableBean;
import org.springframework.util.Assert;
import com.ame.uidgenerator.buffer.BufferPaddingExecutor;
import com.ame.uidgenerator.buffer.RejectedPutBufferHandler;
import com.ame.uidgenerator.buffer.RejectedTakeBufferHandler;
import com.ame.uidgenerator.buffer.RingBuffer;

import java.util.ArrayList;
import java.util.List;

/**
 * Represents a cached implementation of {@link UidGenerator} extends from {@link DefaultUidGenerator}, based on a lock
 ...
 * be <code>({@link BitsAllocator#getMaxSequence()} + 1) &lt;&lt;
