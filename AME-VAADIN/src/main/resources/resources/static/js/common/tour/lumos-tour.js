      ...
      this._options = $.extend({
        ...
        template: '<div class="popover" role="tooltip"> ' +
                      ...
                      '<div class="popover-navigation"> ' +
                          '<div class="btn-group"> ' +
                              '<button id="btnPrev" class="btn btn-sm btn-default" data-role="prev">&laquo; Prev</button> ' +
                              '<button id="btnNext" class="btn btn-sm btn-primary" data-role="next">Next &raquo;</button> ' +
                              '<button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> ' +
                          '</div> ' +
                          '<button id="btnEnd" class="btn btn-sm btn-danger" data-role="end">End Tour</button> ' +
                      '</div> ' +
                  '</div>',
